...
![left_temporal]({{ site.url }}/assets/left_temporal.png){:height="30%"}
...
![joined_temporal]({{ site.url }}/assets/joined_temporal.png){:height="30%"}
...
![array_based_cumsum]({{ site.url }}/assets/array_based_cumsum.png){:height="50%"}
...
![interval_tree_range_query]({{ site.url }}/assets/interval_tree_range_query.png){:height="50%"}
...
![segment_tree_optimization]({{ site.url }}/assets/segment_tree_optimization.png){:height="50%"}
...
![skiplist]({{ site.url }}/assets/skiplist.png){:height="50%"}
...
![skiplist_cumulations]({{ site.url }}/assets/skiplist_cumulations.png){:height="50%"}
...
![unwindowed_optimization]({{ site.url }}/assets/unwindowed_optimization.png){:height="50%"}
...
![distributed_segment_tree]({{ site.url }}/assets/distributed_segment_tree.png){:height="50%"}
...
![skiplist_error]({{ site.url }}/assets/skiplist_error.png){:height="50%"}
